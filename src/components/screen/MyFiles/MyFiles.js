...
const MyFiles = () => {
    ...
    return(
        <div className={styles.container}>
            ...
            {myTransfers.length === 0 && <Card className={`${styles.container} ${styles.warning}`}>Size henüz gelen bir dosya bulunmuyor. Dosya göndermek için dosya gönder sekmesine geçebilirsiniz.</Card>}
